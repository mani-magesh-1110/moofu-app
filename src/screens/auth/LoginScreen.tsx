...
const styles = StyleSheet.create({
  ...
  helpText: { fontWeight: "700" as const, color: Colors.text, fontSize: 12, ...FontFamily.montserratBold },
  title: { marginTop: 34, fontSize: 30, fontWeight: "900", color: Colors.text, textAlign: "center", ...FontFamily.montserratExtraBold },
  inputBlock: { marginTop: 28, paddingHorizontal: 16 },
  inputLabel: { fontWeight: "700" as const, color: Colors.mutedText, marginBottom: 8, fontSize: 12, ...FontFamily.montserratBold },
  ...
  prefixText: { fontWeight: "700" as const, color: Colors.text, fontSize: 13, ...FontFamily.montserratBold },
  note: { marginTop: 18, paddingHorizontal: 16, textAlign: "center", fontWeight: "600" as const, color: Colors.mutedText, fontSize: 12, lineHeight: 18, ...FontFamily.interMedium },
  illustration: {
    marginTop: 18,
    marginHorizontal: 16,
    height: 170,
